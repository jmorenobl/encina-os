...
| [publicar.md](tareas/publicar.md) | La release, y probarla en una máquina que no sea del banco | 2 — **fase 3, y es LO ÚLTIMO del proyecto**; el 2026-08-29 (noche) **la release `v0.2.1` existe, la cosecha está publicada y el README enlaza** (§4.82k-m); quedan el hierro mirando (de Jorge) y conservar la ISO oficial `arm64` (trampa 69, decisión de Jorge) |
