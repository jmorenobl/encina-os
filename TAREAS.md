...
| **[marca-del-medio.md](tareas/marca-del-medio.md)** | **Que el medio y el instalador dejen de decir Ubuntu. Bloquea publicar.** Es lo que se está haciendo | **3** — eran 4, y antes 5: la del logotipo de la rejilla era una **copia rancia** (cerrada el 2026-08-14 en `aspecto/`, donde además se vio que estaba **mal leída**: el botón nunca llevó el logotipo de Ubuntu). **La del inventario se cerró el 2026-08-15** —`MEDICIONES.md` §4.51, 39 apariciones medidas sin arrancar el medio, con instrumento `imagen/inventario-marca.sh`— |
