...
| [alojamiento.md](tareas/alojamiento.md) | 3,46 GB no caben en un release de GitHub | 2 — **fase 3; el 2026-08-29 (`MEDICIONES.md` §4.82) están las opciones con su precio, `make trozos` y `make publicar`, y la decisión de dónde vive la ISO es de Jorge: nada subido** |
| [publicar.md](tareas/publicar.md) | La release, y probarla en una máquina que no sea del banco | 5 — **fase 3, y es LO ÚLTIMO del proyecto**; el 2026-08-29 la cosecha está empaquetada y cotejada contra los dos medios, `cosechar-repo.sh --cosecha` cosecha desde ella, y un clon limpio sin archivo ni Launchpad reproduce las dos huellas (§4.82); la quinta es nueva, la ISO oficial `arm64` sin fuente permanente (trampa 69) |
