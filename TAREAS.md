...
| [alojamiento.md](tareas/alojamiento.md) | 3,46 GB no caben en un release de GitHub | **0 — CERRADO el 2026-08-29 (noche), §4.82j-m: SourceForge, las ISOs con `SHA256SUMS` al lado y bajadas desde fuera con su huella; las notas de la release dicen cómo comprobarlas** |
| [publicar.md](tareas/publicar.md) | La release, y probarla en una máquina que no sea del banco | 1 — **fase 3, y es LO ÚLTIMO del proyecto**; el 2026-08-29 la release `v0.2.1`, la cosecha y el README (§4.82k-m), y el 2026-08-30 la base `arm64` conservada con la firma de Canonical y el clon limpio bajándola del respaldo (§4.83); **queda sólo el hierro mirando, que es de Jorge** |
