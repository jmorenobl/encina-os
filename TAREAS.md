...
| [alojamiento.md](tareas/alojamiento.md) | 3,46 GB no caben en un release de GitHub | 1 — **fase 3; el 2026-08-29 (noche) Jorge eligió SourceForge y las ISOs están subidas con `SHA256SUMS` al lado y bajadas desde fuera con su huella (§4.82j-l): la primera casilla MARCADA; queda «cómo comprobarlas», que son las notas de la release** |
| [publicar.md](tareas/publicar.md) | La release, y probarla en una máquina que no sea del banco | 4 — **fase 3, y es LO ÚLTIMO del proyecto**; el 2026-08-29 (noche) **la cosecha está publicada en SourceForge y su casilla MARCADA** (§4.82k: el clon limpio contra la URL de verdad, con el archivo cortado, da las dos huellas); la quinta es nueva, la ISO oficial `arm64` sin fuente permanente (trampa 69) |
