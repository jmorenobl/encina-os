...
2. **EL USUARIO VE DOS TIENDAS.** Al dejar de purgar `snapd`, el `snap-store`
   ...
   (`snap-store`). **No rompe ninguna casilla y es decisión de producto: sigue
   siendo de Jorge, y es lo único de los tres puntos que sigue entero.**
...
**Siguen siendo DIEZ el 2026-08-12 al cerrar la ISO de E4** (§4.32): se borró
