...
cinco pantallas que pregunta Ubuntu. **La siguiente tarea es E4**, que sigue sin
abrir, y antes de abrirlo aplica el criterio general de §10: **¿qué comando
demuestra que ese problema existe?** Para E4 esa pregunta tiene una forma
concreta y barata —qué le falta hoy a la máquina que sale de la ISO para que
alguien la use— y se contesta **sobre esa máquina**, no sobre una lista de deseos.
