...
**Son once el 2026-08-10 al cerrar el día**, y ya no forman una sola familia.
Ese día se borró `encina-E3-forma` —su pregunta la contestó mejor §4.23— y
nacieron tres: `encina-E3-iso`, `encina-E2-2vias` y `encina-E3-iso-es`.
