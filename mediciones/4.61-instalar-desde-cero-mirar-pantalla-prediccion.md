...
22:11:36Z  utmctl start encina-capa-p10 -> «OSStatus error -1712», codigo de salida 0
           y la VM sigue stopped                         <- trampa 45 y trampa 28 (hoy la 62) juntas
...
y **la VM no arranca**, con `utmctl start` devolviendo **0** otra vez (trampa 28 —hoy la 62, renumerada el 2026-08-28—).
